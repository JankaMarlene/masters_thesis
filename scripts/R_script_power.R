...
#write.csv(table_beta_filtered, file = "table_beta_filtered.csv", row.names = FALSE)
#write.csv(table_delta_filtered, file = "table_delta_filtered.csv", row.names = FALSE)
...
# => use NONPARAMETRIC Tests for beta, delta and the exponent!

# ----- 7. boxplots and stats -------------------
