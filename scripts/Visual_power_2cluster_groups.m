...
output_folder = 'plots\final\cluster2_groups'; 

%% 1. topoplots
%% 1.1 power
% take a data vector and plot it

% Import the group-specific data
data_beta_selfCD_c1 = importdata('data\analysis_power\cluster2_groups\export_beta_selfCD_c1.txt');
data_beta_noCD_c1 = importdata('data\analysis_power\cluster2_groups\export_beta_noCD_c1.txt');
data_beta_selfCD_c2 = importdata('data\analysis_power\cluster2_groups\export_beta_selfCD_c2.txt');
data_beta_noCD_c2 = importdata('data\analysis_power\cluster2_groups\export_beta_noCD_c2.txt');
data_delta_selfCD_c1 = importdata('data\analysis_power\cluster2_groups\export_delta_selfCD_c1.txt');
data_delta_noCD_c1 = importdata('data\analysis_power\cluster2_groups\export_delta_noCD_c1.txt');
data_delta_selfCD_c2 = importdata('data\analysis_power\cluster2_groups\export_delta_selfCD_c2.txt');
data_delta_noCD_c2 = importdata('data\analysis_power\cluster2_groups\export_delta_noCD_c2.txt');
...
set(findobj(gca, 'type', 'patch'), 'facecolor', '#009EC4'); % Set the color
set(gca, 'FontSize', 17);
...
caxis([0.346 2.97]);
xlabel(hc, 'beta Power [μV^2]');
set(findobj(gca, 'type', 'patch'), 'facecolor', '#6ADDF8'); % Set the color
set(gca, 'FontSize', 17);
...
caxis([0.346 2.97]);
xlabel(hc, 'beta Power [μV^2]');
set(findobj(gca, 'type', 'patch'), 'facecolor', '#FDB57A'); % Set the color
set(gca, 'FontSize', 17);
...
caxis([0.172 1.92]);
xlabel(hc, 'delta Power [μV^2]');
set(findobj(gca, 'type', 'patch'), 'facecolor', '#D97700'); % Set the color
set(gca, 'FontSize', 17);
...
data_ape_selfCD_c1 = importdata('data\analysis_power\cluster2_groups\export_ape_selfCD_c1.txt');
data_ape_noCD_c1 = importdata('data\analysis_power\cluster2_groups\export_ape_noCD_c1.txt');
data_ape_selfCD_c2 = importdata('data\analysis_power\cluster2_groups\export_ape_selfCD_c2.txt');
data_ape_noCD_c2 = importdata('data\analysis_power\cluster2_groups\export_ape_noCD_c2.txt');
...
%% 1.2 topoplots Aperiodic Offset (Apo)

% Import the Apo data for both clusters and groups
data_apo_selfCD_c1 = importdata('data\analysis_power\cluster2_groups\export_apo_selfCD_c1.txt');
data_apo_noCD_c1 = importdata('data\analysis_power\cluster2_groups\export_apo_noCD_c1.txt');
data_apo_selfCD_c2 = importdata('data\analysis_power\cluster2_groups\export_apo_selfCD_c2.txt');
data_apo_noCD_c2 = importdata('data\analysis_power\cluster2_groups\export_apo_noCD_c2.txt');
...
data_r_selfCD_c1 = importdata('data\analysis_power\cluster2_groups\export_r_selfCD_c1.txt');
data_r_noCD_c1 = importdata('data\analysis_power\cluster2_groups\export_r_noCD_c1.txt');
data_r_selfCD_c2 = importdata('data\analysis_power\cluster2_groups\export_r_selfCD_c2.txt');
data_r_noCD_c2 = importdata('data\analysis_power\cluster2_groups\export_r_noCD_c2.txt');
